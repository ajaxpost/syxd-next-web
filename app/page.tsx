    ...
    <>
      ...
      <section className=" relative overflow-hidden">
        <div className="pt-20 text-center">
          <h3 className="leading-[44px] text-[32px] max-md:leading-8 max-md:text-lg text-[#262626] font-bold">
            关于监控
          </h3>
        </div>
        <p className="mt-[10px] text-center leading-9 text-lg max-md:leading-[22px] max-md:text-sm max-md:mt-2 text-[#595959]">
      ...
      <section className=" relative overflow-hidden">
        <div className="bg-[#262834] text-white mt-14">
          <div className=" text-center py-8 ">
            <p className="text-[32px] font-medium leading-[32px]">
              让计算产生价值 让数据成为资产
            </p>
            <Link
              href="#"
