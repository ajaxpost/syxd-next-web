...
export default function Page() {
  return (
    <>
      ...
      <section className=" relative overflow-hidden">
        <div className="h-[400px] relative">
          ...
          <div
            ...
            style={{
              background:
                'url(https://qcloudimg.tencent-cloud.cn/trisys/assets/product/images/iIRz3lRglgEcOf5N5FEBd.jpg)',
          ...
          ></div>
          {/* inner */}
          <div className="max-w-[1200px] pb-[30px] mx-auto pt-[62px] px-[10px] h-full relative z-10">
            <div className="mb-3 flex items-center">
              <h1 className="text-[40px] leading-[52px] font-medium text-[#000] whitespace-nowrap overflow-hidden text-ellipsis">
                <span>云服务器</span>
              </h1>
            </div>
            <p className="text-base leading-7 w-[60%] dark:text-[rgba(0,0,0,0.7)]">
            ...
            <div className="mt-8 flex items-center">
              <Link
                href="#"
                className="min-w-[152px] hover:bg-[#528eff] h-[40px] px-6 whitespace-nowrap text-center text-sm font-medium leading-[38px] bg-[#2468f2]"
              >
                <span className="text-white">立即选购</span>
              </Link>
              <Link
                href="#"
                className="min-w-[152px] ml-4 hover:border-[#2468f2] border transition-all h-[40px] px-6 whitespace-nowrap text-center text-sm font-medium leading-[38px] bg-white border-[#e5e7eb]"
              >
      ...
      <section className=" relative overflow-hidden pt-[60px] pb-[80px]">
        <div className="h-[446px] max-w-[1200px] mx-auto overflow-hidden ">
          <h3 className="leading-[44px] text-center text-[32px] max-md:leading-8 max-md:text-lg text-foreground font-bold">
            产品优势
          </h3>
          <div className="grid grid-cols-4 gap-5">
            <div className="p-4">
              <div className="dark:border hover:shadow cursor-default p-6 text-center">
                <Image
                ...
                <p className="min-h-[150px] text-left text-muted-foreground text-sm leading-[30px] ">
      ...
      <section className=" relative overflow-hidden bg-[#fafbff] dark:bg-background pb-[30px] pt-[60px]">
        <div className="max-w-[1200px]  mx-auto overflow-hidden  min-h-[446px] ">
          ...
          <div className="grid grid-cols-3 gap-5 mt-5">
            <div className="p-4 border hover:shadow">
      ...
      <section className=" relative overflow-hidden pb-[30px] pt-[60px]">
        <div className="max-w-[1200px] mx-auto overflow-hidden min-h-[446px]">
          ...
          <div className="grid grid-cols-3 grid-rows-2 gap-5 mt-5">
            <div className="py-5">
              <div className="pr-[30%] pb-[10%] flex items-start">
                <Image
      ...
      <section className=" relative overflow-hidden pb-[30px] pt-[60px] bg-[#fafbff]">
        <div className="max-w-[1200px] mx-auto overflow-hidden min-h-[446px]">
          <h3 className="leading-[44px] text-center text-[32px] max-md:leading-8 max-md:text-lg text-foreground font-bold">
            应用场景
          </h3>
          <div className="grid grid-cols-3 gap-5 mt-5">
            <div className="p-4 bg-background border">
              <div className="p-[40px]">
                ...
                <p className="text-left leading-[30px] text-muted-foreground text-sm min-h-[250px]">
