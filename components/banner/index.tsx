...
export default function Banner() {
  ...
  return (
    <section className=" relative">
      <div className="max-md:h-[210px] h-[560px] relative">
        {/* banner wrap */}
          ...
          {config.map((item, key) => {
            return (
              ...
              >
                ...
                <div className=" relative z-20 max-md:pt-[60px] max-md:absolute top-[0px] left-4 max-md:left-8 text-left max-md:w-[190px] pt-[150px] s-w">
        ...
        {/* banner page */}
        <div className=" s-w relative left-0 pl-4 max-md:pl-8 z-30 max-md:-top-[20%]  -top-[33%] h-[17px]">
          {config.map((_, key) => {
            return (
              <div
                key={key}
